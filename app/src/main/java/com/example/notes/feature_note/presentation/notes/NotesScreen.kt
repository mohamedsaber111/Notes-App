...
fun NotesScreen(
    ...
    //val scaffoldState = rememberScaffoldState() in material3 replaced by SnackbarHostState()
    //to show snackBars
    ...
    Scaffold(
        ...
        Column(
            ...
            AnimatedVisibility(
                ...
                //animate all radio buttons when hide
                OrderSection(
                    modifier = Modifier
                        .fillMaxWidth()
                ...
                items(state.notes) { note ->
                    ...
                    NoteItem(
                        ...
                        onDeleteClick = {
                            ...
                            //show snackbar to successful deleted or Undo
                            //snackbaruse coroutine because it's take some time to show it
                            scope.launch {
                                //change from material 3
